...
### 特别提醒
- 周期股新闻通常具有误导性：利空最多时往往已是底部
- 不要因为"行业前景悲观"就放弃低位建仓机会
- 但也要警惕"周期陷阱"：有些行业可能永久衰退
- 仓位控制很重要，周期股波动极大

### 输出格式（必须严格遵循）
1. 【决策】：[双倍补仓 / 正常定投 / 暂停定投 / 观望] 之一
2. 【信心度】：[高/中/低]
3. 【核心理由】：基于周期分析和当前位置的判断（50字内）

注意：理由必须体现周期投资的逆向思维，不要被短期新闻影响判断。"""
